  ...
  return (
    <>
      <div className="relative">
        <div
          className={`group bg-slate-800 border rounded-xl overflow-hidden hover:bg-slate-750 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-200 cursor-pointer ${
            isSelected 
        ...
        >
          ...
          <div className="relative aspect-square bg-slate-700 flex items-center justify-center file-card-content">
            {file.type === 'video' ? (
              <VideoPlayer
                src={getFileUrl()}
      ...
      {/* Video Player Modal */}
      {showVideoPlayer && file.type === 'video' && (
          ...
          <div className="relative w-full h-full max-w-6xl max-h-full bg-slate-800 rounded-xl overflow-hidden">
            ...
            <div className="flex h-full">
              ...
              <div className="w-80 bg-slate-700 p-6 overflow-y-auto">
                <h3 className="text-lg font-bold text-white mb-4">{file.name}</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 text-sm">{file.fileType}</p>
                  </div>
